...
from nnunetv2.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss, DC_CE_Boundary_Loss
...
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.BoundaryTransUNet.boundaryTransUNet import \
    BoundaryTransUNet
...
class nnUNetTrainer(object):
    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            # ).to(self.device)
            self.network = BoundaryTransUNet(1, 11).to(self.device)
    ...
    def _build_loss(self):
        if self.label_manager.has_regions:
            ...
            soft_dice_kwargs={'batch_dice': self.configuration_manager.batch_dice, 'do_bg': False, 'smooth': 1e-5, 'ddp': self.is_ddp},
            ce_kwargs={},
            boundary_kwargs={},
            weight_ce=1,
            weight_dice=1,
